...
if tags.has("scm_theme"):
    ...
    project = "PLAMS"
    copyright = "%i, Software for Chemistry & Materials" % (date.today().year)
    ...
    # Suppress import warnings from SCM packages which are unavailable on the open-source build
    if os.getenv("IGNORE_IMPORT_ERRORS") == "true":
