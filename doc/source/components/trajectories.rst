...
information on its periodicity, atomic elements, and the locations of covalent bonds.
...
as well as write (altered) conformations to a new trajectory file in one of the three formats described above.
